        ...
        appBar: PreferredSize(
          ...
          child: Container(
            decoration: BoxDecoration(
              color:Color.fromRGBO(3,82,138,1),
            ...
            child: Column(
              ...
              children: [
                ...
                CustomText(
                  ...
                  fontSize: 26,
                  color: Colors.white,
                  fontweight: FontWeight.w900, fontFamily: '',
                ),
              ],
            ),
          ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        CustomText(
                                          ...
                                          fontSize: 25,
                                          fontweight: FontWeight.bold,
                                          color: Color.fromRGBO(3,82,138,1) , alignment:  Alignment.center,
                                          fontFamily: '',
                                        ),
                                      ],
                                    ),
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        CustomText(
                                          ...
                                          fontSize: 23,
                                          fontweight: FontWeight.bold,
                                          color: Color.fromRGBO(3,82,138,1), alignment:  Alignment.center, fontFamily: '',
                                        ),
                                        CustomText(
                                          text: "الممتحنه",
                                          fontSize: 23,
                                          fontweight: FontWeight.bold,
                                          color:Color.fromRGBO(3,82,138,1),
                                          alignment:  Alignment.center, fontFamily: '',
                                        ),
                                      ],
                                    ),
                                  ),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        child: CircleAvatar(
                            backgroundColor: Color.fromRGBO(3,82,138,1),
                            child: IconButton(
                              icon: Icon(
                                Icons.arrow_back,
                                color: Colors.white,
